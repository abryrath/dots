# log
# Autogenerated from man page /Library/Developer/CommandLineTools/SDKs/MacOSX10.14.sdk/usr/share/man/man1/log.1
...
complete -c log -l info --description 'Disable or enable info level messages in the output.'
complete -c log -l debug --description 'Disable or enable debug level messages in the output.'
complete -c log -l signpost --description 'Disable or enable display of signposts in the output.'
