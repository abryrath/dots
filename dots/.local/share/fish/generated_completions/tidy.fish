# tidy
# Autogenerated from man page /usr/local/share/man/man1/tidy.1
complete -c tidy -o file --description 'write errors and warnings to the specified <file>.'
complete -c tidy -s w --description 'wrap text at the specified <column>.  0 is assumed if <column> is missing.'
...
complete -c tidy -l gnu-emacs --description 'br This option specifies if Tidy should change the format for reporting error…'
...
complete -c tidy -l hide-comments --description 'br This option specifies if Tidy should print out comments.'
