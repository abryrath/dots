# heap
# Autogenerated from man page /Library/Developer/CommandLineTools/SDKs/MacOSX10.14.sdk/usr/share/man/man1/heap.1
complete -c heap -s s --description 'Sort output by total size of class instances, rather than by count.'
complete -c heap -s z --description 'Show the output separated out into the different malloc zones, instead of an …'
