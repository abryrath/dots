...
complete -c nvim -o es --description 'Silent/batch mode, reading stdin as Ex commands.  :help silent-mode.'
complete -c nvim -o '\\&Es' --description 'Silent/batch mode, reading stdin as text.  :help silent-mode.'
