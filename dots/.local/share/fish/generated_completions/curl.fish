# curl
# Autogenerated from man page /Library/Developer/CommandLineTools/SDKs/MacOSX10.14.sdk/usr/share/man/man1/curl.1
...
complete -c curl -l connect-to --description 'For a request to the given HOST:PORT pair, connect to CONNECT-TO-HOST:CONNECT…'
...
complete -c curl -l environment --description 'Sets a range of environment variables, using the names the -w, --write-out op…'
...
complete -c curl -l form-string --description '(HTTP) Similar to -F, --form except that the value string for the named param…'
...
complete -c curl -s i -l include --description 'Include the HTTP-header in the output.'
